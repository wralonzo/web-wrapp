...
export class AddBranchComponent extends PageConfiguration {
    ...
    async register(form: NgForm) {
        ...
        try {
            await this.rustService.call(async (bridge: GenericHttpBridge) => {
                return await bridge.post('/branch', this.branch);
            });
            this.toast.show('Sucursal registrada exitosamente', 'success');
